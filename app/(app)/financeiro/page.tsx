    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h1 className="mt-1.5 text-2xl font-semibold text-[#11231f]">Financeiro da empresa</h1>
      ...
      <div className="grid gap-3 xl:grid-cols-[0.68fr_1.32fr]">
        <Card className="atlas-dark-panel">
          ...
          <CardContent className="space-y-2.5">
            <div className="rounded-md border border-[#d7ad68]/20 bg-[#0f2d27]/70 p-2.5">
        ...
        <Card className="atlas-panel">
          ...
          <CardContent className="space-y-2">
            {lista.length > 0 ? lista.map((t) => {
              ...
              return (
                <div key={t.id} className="grid gap-2.5 rounded-md border border-[#d7ad68]/25 bg-white/65 p-2.5 md:grid-cols-[1fr_auto_auto_auto] md:items-center">
                  <div>
              ...
              <p className="py-8 text-center text-sm text-muted-foreground">Nenhuma transacao em {labelPeriodo}.</p>
            )}
          </CardContent>
        </Card>
      </div>
